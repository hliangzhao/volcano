...
// +kubebuilder:rbac:groups=scheduling.hliangzhao.io,resources=podgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=scheduling.hliangzhao.io,resources=podgroups/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=scheduling.hliangzhao.io,resources=podgroups/finalizers,verbs=update
